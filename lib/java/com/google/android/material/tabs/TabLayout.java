...
public class TabLayout extends HorizontalScrollView {
  ...
  private int tabIndicatorInterpolatorWidth = -1;
  ...
  public TabLayout(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    if (selectedTabTextAppearance != -1) {
      ...
      @SuppressLint("CustomViewStyleable") final TypedArray selectedTabTA =
          context.obtainStyledAttributes(
  ...
  /**
   * Sets the tab indicator interpolator width.
   *
   * @param width The width value for the tab indicator interpolator. If set to -1,
   * the default value or special behavior will be used (depending on the implementation).
   */
  public void setTabIndicatorInterpolatorWidth(int width) {
    tabIndicatorInterpolatorWidth = width;
    updateAllTabs();
  }

  /**
   * Gets the tab indicator interpolator width.
   *
   * @return The current width value of the tab indicator interpolator. If -1 is returned,
   * it indicates the default value or special behavior is in effect (depending on the implementation).
   */
  public int getTabIndicatorInterpolatorWidth() {
    return tabIndicatorInterpolatorWidth;
  }
